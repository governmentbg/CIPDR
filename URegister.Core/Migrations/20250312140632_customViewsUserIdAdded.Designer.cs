...
namespace URegister.Core.Migrations
{
    ...
    [Migration("20250312140632_customViewsUserIdAdded")]
    partial class customViewsUserIdAdded
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("URegister.Core.Data.Models.Common.FieldTemplate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("URegister.Core.Data.Models.Process.Process", b =>
                {
                    ...
                    b.HasIndex("TenantId")
                        .HasDatabaseName("ix_processes_tenant_id");
            ...
            modelBuilder.Entity("URegister.Core.Data.Models.Process.RegisterItem", b =>
                {
                    ...
                    b.HasIndex("TenantId")
                        .HasDatabaseName("ix_register_items_tenant_id");
            ...
            modelBuilder.Entity("URegister.Core.Data.Models.Register.Administration", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("URegister.Core.Data.Models.Register.AdministrationPerson", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("URegister.Core.Data.Models.Process.Process", b =>
                {
                    ...
                    b.HasOne("URegister.Core.Data.Models.Register.Administration", "Administration")
                        .WithMany()
                        .HasForeignKey("TenantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_processes_administrations_tenant_id");
            ...
            modelBuilder.Entity("URegister.Core.Data.Models.Process.RegisterItem", b =>
                {
                    ...
                    b.HasOne("URegister.Core.Data.Models.Register.Administration", "Administration")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_register_items_administrations_tenant_id");
            ...
            modelBuilder.Entity("URegister.Core.Data.Models.Register.Administration", b =>
                {
                    b.HasOne("URegister.Core.Data.Models.Register.Register", "Register")

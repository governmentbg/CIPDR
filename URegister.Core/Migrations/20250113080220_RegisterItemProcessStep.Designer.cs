...
namespace URegister.Core.Migrations
{
    ...
    [Migration("20250113080220_RegisterItemProcessStep")]
    partial class RegisterItemProcessStep
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("URegister.Core.Data.Models.Process.Process", b =>
                {
                    ...
                    b.HasIndex("TennantId")
                        .HasDatabaseName("ix_processes_tennant_id");
            ...
            modelBuilder.Entity("URegister.Core.Data.Models.Process.RegisterItem", b =>
                {
                    ...
                    b.Property<bool>("IsDelеted")
                        .HasColumnType("boolean")
                        .HasColumnName("is_delеted")
                    ...
                    b.HasIndex("TennantId")
                        .HasDatabaseName("ix_register_items_tennant_id");
            ...
            modelBuilder.Entity("URegister.Core.Data.Models.Process.Process", b =>
                {
                    ...
                    b.HasOne("URegister.Core.Data.Models.Register.Administration", "Administration")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_processes_administrations_tennant_id");
            ...
            modelBuilder.Entity("URegister.Core.Data.Models.Process.RegisterItem", b =>
                {
                    ...
                    b.HasOne("URegister.Core.Data.Models.Register.Administration", "Administration")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_register_items_administrations_tennant_id");

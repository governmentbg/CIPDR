...
namespace URegister.Core.Migrations
{
    ...
    [Migration("20250116111338_IsColumnInDataTableAddedInRegisterItem")]
    partial class IsColumnInDataTableAddedInRegisterItem
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("URegister.Core.Data.Models.Process.ProcessStep", b =>
                {
                    ...
                    b.HasIndex("FormId")
                        .HasDatabaseName("ix_process_steps_form_id");
            ...
            modelBuilder.Entity("URegister.Core.Data.Models.Process.RegisterItem", b =>
                {
                    ...
                    b.Property<bool?>("IsColumnInDataTable")
                        .HasColumnType("boolean")
                        .HasColumnName("is_column_in_data_table")
                        .HasComment("Дали полето ще бъде колона при визуализиране на данните в таблица");
            ...
            modelBuilder.Entity("URegister.Core.Data.Models.Process.ProcessStep", b =>
                {
                    b.HasOne("URegister.Core.Data.Models.Common.Form", "Form")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_process_steps_forms_form_id");

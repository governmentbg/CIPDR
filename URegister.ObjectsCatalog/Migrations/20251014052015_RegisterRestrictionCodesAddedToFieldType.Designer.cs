...
namespace URegister.ObjectsCatalog.Migrations
{
    ...
    [Migration("20251014052015_RegisterRestrictionCodesAddedToFieldType")]
    partial class RegisterRestrictionCodesAddedToFieldType
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("URegister.ObjectsCatalog.Data.Models.FieldType", b =>
                {
                    ...
                    b.Property<List<string>>("RegisterRestrictionCodes")
                        .HasColumnType("jsonb")
                        .HasColumnName("register_restriction_codes")
                        .HasComment("Списък на регистрите, за които полето е достъпно. Празен списък означава достъпно за всички");
            ...
            modelBuilder.Entity("URegister.ObjectsCatalog.Data.Models.Step", b =>
                {
                    ...
                    b.Property<bool>("IsForOfficialUse")
                        ...
                        .HasComment("Стъпката е достъпна при официална услуга");

                    b.Property<bool>("IsForPublicUse")
                        .HasColumnType("boolean")
                        .HasColumnName("is_for_public_use")

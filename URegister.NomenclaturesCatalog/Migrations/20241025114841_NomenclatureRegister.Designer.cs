...
namespace URegister.NomenclaturesCatalog.Migrations
{
    ...
    [Migration("20241025114841_NomenclatureRegister")]
    partial class NomenclatureRegister
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("URegister.NomenclaturesCatalog.Data.Models.CodeableConceptRegister", b =>
                {
                    ...
                    b.HasIndex("CodeableConceptId", "RegisterId")
                        .IsUnique()
                        .HasDatabaseName("ix_codeable_concept_registers_codeable_concept_id_register_id");
            ...
            modelBuilder.Entity("URegister.NomenclaturesCatalog.Data.Models.CodeableConceptRegister", b =>
                {
                    b.HasOne("URegister.NomenclaturesCatalog.Data.Models.CodeableConcept", "CodeableConcept")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_codeable_concept_registers_codeable_concepts_codeable_conce");

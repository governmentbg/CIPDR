...
namespace URegister.NomenclaturesCatalog.Migrations
{
    ...
    [Migration("20250121133531_valueENDescriptionInCodeableConceptsFixed")]
    partial class valueENDescriptionInCodeableConceptsFixed
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("URegister.NomenclaturesCatalog.Data.Models.CodeableConcept", b =>
                {
                    ...
                    b.HasIndex("Type", "Code", "DateFrom")
                        .IsUnique()
                        .HasDatabaseName("ix_codeable_concepts_type_code_date_from");
            ...
            modelBuilder.Entity("URegister.NomenclaturesCatalog.Data.Models.CodeableConceptRegister", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<string>("Code")
                        ...
                        .HasColumnType("text")
                        .HasColumnName("code")
                        .HasComment("Код на номенклатура");
                    ...
                    b.HasIndex("Type", "Code", "RegisterId")
                        .IsUnique()
                        .HasDatabaseName("ix_codeable_concept_registers_type_code_register_id");
            ...
            modelBuilder.Entity("URegister.NomenclaturesCatalog.Data.Models.NomenclatureType", b =>
                {
                    ...
                    b.Property<bool>("IsPublic")
                        ...
                        .HasComment("Публичен номенклатурен тип");
            ...
            modelBuilder.Entity("URegister.NomenclaturesCatalog.Data.Models.NomenclatureTypeRegister", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasIndex("NomenclatureTypeId", "RegisterId")
                        .IsUnique()
                        .HasDatabaseName("ix_nomenclature_type_registers_nomenclature_type_id_register_id");

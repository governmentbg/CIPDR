...
namespace URegister.RegistersCatalog.Migrations
{
    ...
    [Migration("20241203150349_RegisterAdministration")]
    partial class RegisterAdministration
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("URegister.RegistersCatalog.Data.Models.RegisterAdministration", b =>
                {
                    ...
                    b.HasIndex("AdministrationId")
                        .HasDatabaseName("ix_administrations_administration_id");

                    b.HasIndex("RegisterId", "AdministrationId")
                        .IsUnique()
                        .HasDatabaseName("ix_administrations_register_id_administration_id");
            ...
            modelBuilder.Entity("URegister.RegistersCatalog.Data.Models.RegisterAdministration", b =>
                {
                    b.HasOne("URegister.RegistersCatalog.Data.Models.Administration", "Administration")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_administrations_administration_administration_id");

...
namespace URegister.NumberGenerator.Migrations
{
    ...
    [Migration("20240920180322_InitialMigration")]
            ...
            modelBuilder.Entity("URegister.NumberGenerator.Data.Models.Numerator", b =>
                {
                    ...
                    b.Property<string>("AdministrationCode")
                        ...
                        .HasMaxLength(10)
                        .HasColumnType("character varying(10)")
                        .HasColumnName("administration_code")
                        .HasComment("Код на администрацията");
                    ...
                    b.HasIndex("AdministrationCode", "Year")
                        .IsUnique()
                        .HasDatabaseName("ix_numerators_administration_code_year");

                    b.ToTable("numerators", null, t =>
                        {
                            t.HasComment("Номератори на институциите използващи универсалния регистър");
                        });
                });

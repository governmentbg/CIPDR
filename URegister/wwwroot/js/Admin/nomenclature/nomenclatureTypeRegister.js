        ...
        let dt = $(tableId).DataTable({
            ...
            columns: [
                ...
                },
                {
                    ...
                    width: 120,
                    "render": function (data, type, row) {
                        return `<a href="/Admin/Nomenclature/indexRegister?nomenclatureType=${row.type}&registerId=${registerId}" data-tooltip="Стойности" class="ui tertiary icon button">
...
async function updateNomenclatureTypeRegister(data) {
    await post_fetch_string_async('/Admin/Nomenclature/UpdateNomenclatureTypeRegister', data);
    LoadNomenclatureTypeRegisters()
}
